...
import org.maurodata.dita.ebnf.parser.EbnfLexer
import org.maurodata.dita.ebnf.parser.EbnfParser
...
class SpecificationParser implements Callable<Map<String, DitaElementSpecification>> {
    ...
    Map<String, DitaElementSpecification> call() throws Exception {
        try {
            ...
            String fileUrl = DocumentationParser.BASE_URL + "cmlt${letter}.html"
    ...
    Map<String, DitaElementSpecification> getSpecificationsFromWebPage(GPathResult doc) {
        ...
        doc.'**'.findAll {
            ...
            DocumentationParser.ATTRIBUTE_GROUP_MAP.each {key, value ->
            ...
            attributeGroupNames.each {
                originalAttributes.addAll(DocumentationParser.ATTRIBUTE_GROUP_ITEMS[it])
            }
    ...
    static String getAttributeName(String elementName) {
        ...
        DocumentationParser.REPLACEMENTS.each {replacement ->
