...
set CLASSPATH=%DITA_DIR%lib\Saxon-HE-9.9.1-7.jar;%CLASSPATH%
...
set CLASSPATH=%DITA_DIR%plugins\com.elovirta.ooxml\lib\ant-contrib-0.6.jar;%CLASSPATH%
...
set CLASSPATH=%DITA_DIR%plugins\org.dita.pdf2.fop\lib\batik-all-1.13.jar;%CLASSPATH%
set CLASSPATH=%DITA_DIR%plugins\org.dita.pdf2.fop\lib\fontbox-2.0.21.jar;%CLASSPATH%
set CLASSPATH=%DITA_DIR%plugins\org.dita.pdf2.fop\lib\fop-2.5.jar;%CLASSPATH%
set CLASSPATH=%DITA_DIR%plugins\org.dita.pdf2.fop\lib\fop-pdf-images-2.5.jar;%CLASSPATH%
...
set CLASSPATH=%DITA_DIR%plugins\org.dita.pdf2.fop\lib\pdfbox-2.0.21.jar;%CLASSPATH%
